...
#define STB_KP951056516 0.951056516295153572116439333379382143405698634f
#endif

#ifndef STB_KP587785252
#define STB_KP587785252 0.587785252292473129168705954639072768597652438f
#endif

#ifndef STB_KP559016994
#define STB_KP559016994 0.559016994374947424102293417182819058860154590f
#endif

#ifndef STB_KP866025403
#define STB_KP866025403 0.866025403784438646763723170752936183471402627f
#endif

#ifndef STB_KP900968867
#define STB_KP900968867 0.900968867902419126236102319507445051165919162f
#endif

#ifndef STB_KP222520933
#define STB_KP222520933 0.222520933956314404288902564496794759466355569f
#endif

#ifndef STB_KP623489801
#define STB_KP623489801 0.623489801858733530525004884004239810632274731f
#endif

#ifndef STB_KP781831482
#define STB_KP781831482 0.781831482468029808708444526674057750232334519f
#endif

#ifndef STB_KP974927912
#define STB_KP974927912 0.974927912181823607018131682993931217232785801f
#endif

#ifndef STB_KP433883739
#define STB_KP433883739 0.433883739117558120475768332848358754609990728f
#endif

#ifndef STB_KP707106781
#define STB_KP707106781 0.707106781186547524400844362104849039284835938f
#endif

#ifndef STB_TWOPI
#define STB_TWOPI 6.283185307179586476925286766559005768394338798750211641949889f
#endif

#ifndef STB_PI
#define STB_PI    3.141592653589793238462643383279502884197169399375105820974944f
#endif
...
void stb_radix_3_dit(const cmplx *tw, cmplx *out, int count) {
    ...
    stb_real_t T5 = T1 - 0.5f * (T2 + T3);
    out[2 * count].real = T5 - T8;
    out[count].real = T5 + T8;
    stb_real_t T12 = T10 - 0.5f * (T6 + T7);
    ...
    while (m < count) {
        ...
        output[2 * count].real = T1_0 - 0.5f * T12_0 - T16;
        output[count].real = T1_0 - 0.5f * T12_0 + T16;
        stb_real_t T20 = T18 - 0.5f * T17;
...
void stb_radix_5_dit(const cmplx *tw, cmplx *out, int count) {
    ...
    stb_real_t T11 = T9 + T1 - 0.25f * T8;
    stb_real_t T19 = T1 - 0.25f * T8 - T9;
    ...
    stb_real_t T27 = T23 + T24 - 0.25f * T25;
    stb_real_t T32 = T24 - 0.25f * T25 - T23;
    ...
    while (m < count) {
        ...
        stb_real_t T27_0 = (T12_0 - T23_0) * STB_KP559016994 + T1_0 - 0.25f * T24_0;
        stb_real_t T35 = T1_0 - 0.25f * T24_0 - (T12_0 - T23_0) * STB_KP559016994;
        ...
        stb_real_t T43 = (T37 - T38) * STB_KP559016994 + T40 - 0.25f * T39;
        stb_real_t T48 = T40 - 0.25f * T39 - (T37 - T38) * STB_KP559016994;
...
void stb_radix_6_dit(const cmplx *tw, cmplx *out, int count) {
    ...
    out[5 * count].real = T3 - 0.5f * T10 - T22;
    out[count].real = T3 - 0.5f * T10 + T22;
    stb_real_t T23 = (T7 - T8 - (T4 - T5)) * STB_KP866025403;
    stb_real_t T28 = T24 - T25 - 0.5f * T27;
    out[count].imag = T23 + T28;
    out[5 * count].imag = T28 - T23;
    stb_real_t T32 = (T16 + T17 - (T19 + T20)) * STB_KP866025403;
    out[2 * count].real = T11 - 0.5f * T14 - T32;
    out[4 * count].real = T11 - 0.5f * T14 + T32;
    stb_real_t T35 = T24 + T25 - 0.5f * T34;
    ...
    while (m < count) {
        ...
        stb_real_t T35_0 = output[0].real - T6_0 - 0.5f * T30_0;
        ...
        stb_real_t T51 = T50 - 0.5f * (T44 + T45);
...
void stb_radix_3_idit(const cmplx *tw, cmplx *out, int count) {
    ...
    out[0].real = out[0].real + T2 + T3;
    out[0].imag = T6 + T7 + T8;
    stb_real_t T10 = T6 - 0.5f * (T7 + T8);
    out[count].imag = T5 + T10;
    out[2 * count].imag = T10 - T5;
    stb_real_t T11 = T1 - 0.5f * (T2 + T3);
...
void stb_radix_5_idit(const cmplx *tw, cmplx *out, int count) {
    ...
    stb_real_t T19 = T10 + T1 - 0.25f * T8;
    out[2 * count].real = T1 - 0.25f * T8 - T10 - T18;
    out[4 * count].real = T19 + T20;
    out[3 * count].real = T1 - 0.25f * T8 - T10 + T18;
    out[count].real = T19 - T20;
    stb_real_t T31 = STB_KP587785252 * (T2 - T3) - STB_KP951056516 * (T5 - T6);
    stb_real_t T30 = T26 + T27 - 0.25f * T28;
    stb_real_t T32 = T27 - 0.25f * T28 - T26;
    ...
    while (m < count) {
        ...
        stb_real_t T27_0 = T1_0 - 0.25f * T24_0 - (T12_0 - T23_0) * STB_KP559016994;
        stb_real_t T35 = (T12_0 - T23_0) * STB_KP559016994 + T1_0 - 0.25f * T24_0;
        ...
        stb_real_t T46 = (T37 - T38) * STB_KP559016994 + T40 - 0.25f * T39;
        stb_real_t T48 = T40 - 0.25f * T39 - (T37 - T38) * STB_KP559016994;
...
void stb_radix_6_idit(const cmplx *tw, cmplx *out, int count) {
    ...
    out[count].imag = T23 + T28;
    out[5 * count].imag = T28 - T23;
    stb_real_t T33 = T24 + T25 - 0.5f * T32;
    ...
    out[2 * count].real = T11 - 0.5f * T14 - T36;
    out[4 * count].real = T11 - 0.5f * T14 + T36;
    output = out + 1;
    m = 1;
    while (m < count) {
        stb_real_t T49 = output[0].imag;
        ...
        stb_real_t T51 = T50 - 0.5f * (T45 + T44);
...
void stb_fft_r2c_exec(stb_fft_real_plan *plan, const stb_real_t *input, cmplx *output) {
    ...
    for (int c = 1; c <= n / 2; ++c) {
        ...
        output[c].real = (r + (t.real + plan->buffer[c].real)) * 0.5f;
        output[c].imag = (i + (t.imag + plan->buffer[c].imag)) * 0.5f;
        output[n - c].real = ((t.real + plan->buffer[c].real) - r) * 0.5f;
        output[n - c].imag = (i - (t.imag + plan->buffer[c].imag)) * 0.5f;
    }
}
